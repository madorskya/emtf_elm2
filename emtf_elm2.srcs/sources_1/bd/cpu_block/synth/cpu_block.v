...
module cpu_block
   (c2c_refclk_clk_n,
    ...
    i2c1_sda,
    synth_rst);
  (* X_INTERFACE_INFO = "xilinx.com:interface:diff_clock:1.0 c2c_refclk CLK_N" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME c2c_refclk, CAN_DEBUG false, FREQ_HZ 250000000" *) input c2c_refclk_clk_n;
  (* X_INTERFACE_INFO = "xilinx.com:interface:diff_clock:1.0 c2c_refclk CLK_P" *) input c2c_refclk_clk_p;
  ...
  wire [0:0]aurora_64b66b_0_lane_up;
  wire aurora_64b66b_0_link_reset_out;
  wire [63:0]aurora_64b66b_0_m_axi_rx_tdata;
  wire aurora_64b66b_0_m_axi_rx_tvalid;
  ...
  wire [63:0]axi_chip2chip_0_axi_c2c_aurora_tx_tdata;
  ...
  wire dsync_0_outp;
  wire gpio_split_0_o0;
  wire [31:0]gpio_split_0_rd_data;
  ...
  wire zynq_ultra_ps_e_0_emio_i2c1_scl_o;
  wire zynq_ultra_ps_e_0_emio_i2c1_scl_t;
  wire zynq_ultra_ps_e_0_emio_i2c1_sda_o;
  wire zynq_ultra_ps_e_0_emio_i2c1_sda_t;
  wire zynq_ultra_ps_e_0_pl_resetn0;

  assign GT_DIFF_REFCLK1_0_1_CLK_N = c2c_refclk_clk_n;
  assign GT_DIFF_REFCLK1_0_1_CLK_P = c2c_refclk_clk_p;
  assign GT_SERIAL_RX_0_1_RXN = c2c_rx_rxn[0];
  assign GT_SERIAL_RX_0_1_RXP = c2c_rx_rxp[0];
  assign c2c_tx_txn[0] = aurora_64b66b_0_GT_SERIAL_TX_TXN;
  assign c2c_tx_txp[0] = aurora_64b66b_0_GT_SERIAL_TX_TXP;
  assign ffly_rst[1:0] = xlconstant_1_dout;
  assign synth_rst[3:0] = xlconstant_0_dout;
  cpu_block_aurora_64b66b_0_1 aurora_64b66b_0
       (.channel_up(aurora_64b66b_0_channel_up),
        ...
        .m_axi_rx_tdata(aurora_64b66b_0_m_axi_rx_tdata),
        .m_axi_rx_tvalid(aurora_64b66b_0_m_axi_rx_tvalid),
        ...
        .s_axi_tx_tdata(axi_chip2chip_0_axi_c2c_aurora_tx_tdata),
        .s_axi_tx_tready(aurora_64b66b_0_s_axi_tx_tready),
        .s_axi_tx_tvalid(axi_chip2chip_0_axi_c2c_aurora_tx_tvalid),
  ...
  cpu_block_axi_bram_ctrl_0_0 axi_bram_ctrl_0
  ...
  cpu_block_axi_chip2chip_0_0 axi_chip2chip_0
       (.aurora_init_clk(clk_wiz_0_clk_out1),
        ...
        .axi_c2c_aurora_rx_tdata(aurora_64b66b_0_m_axi_rx_tdata),
        .axi_c2c_aurora_rx_tvalid(aurora_64b66b_0_m_axi_rx_tvalid),
        .axi_c2c_aurora_tx_tdata(axi_chip2chip_0_axi_c2c_aurora_tx_tdata),
        .axi_c2c_aurora_tx_tready(aurora_64b66b_0_s_axi_tx_tready),
  ...
  cpu_block_blk_mem_gen_0_0 blk_mem_gen_0
  ...
  cpu_block_dsync_0_0 dsync_0
       (.clk(clk_wiz_0_clk_out1),
        .inp(gpio_split_0_o0),
        .outp(dsync_0_outp));
  cpu_block_gpio_split_0_0 gpio_split_0
       (.addr(axi_bram_ctrl_1_bram_addr_a),
        .clk_a(axi_bram_ctrl_1_bram_clk_a),
        .en(axi_bram_ctrl_1_bram_en_a),
        .i0(aurora_64b66b_0_link_reset_out),
        .i1(aurora_64b66b_0_sys_reset_out),
        .i10(gpio_split_0_o0),
        .i11(aurora_64b66b_0_channel_up),
        .i12(aurora_64b66b_0_mmcm_not_locked_out),
        .i13(aurora_64b66b_0_hard_err),
        .i14(aurora_64b66b_0_lane_up),
        .i15(aurora_64b66b_0_soft_err),
        .i2(aurora_64b66b_0_gt_reset_out),
        .i3(aurora_64b66b_0_gt_powergood),
        .i4(axi_chip2chip_0_aurora_pma_init_out),
        .i5(axi_chip2chip_0_aurora_reset_pb),
        .i6(axi_chip2chip_0_axi_c2c_config_error_out),
        .i7(axi_chip2chip_0_axi_c2c_link_status_out),
        .i8(axi_chip2chip_0_axi_c2c_multi_bit_error_out),
        .i9(axi_chip2chip_0_axi_c2c_link_error_out),
        .o0(gpio_split_0_o0),
        .rd_data(gpio_split_0_rd_data),
        .rst(axi_bram_ctrl_1_bram_rst_a),
        .we(axi_bram_ctrl_1_bram_we_a),
        .wr_data(axi_bram_ctrl_1_bram_wrdata_a));
  cpu_block_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  cpu_block_util_ds_buf_0_0 util_ds_buf_0
       (.IOBUF_IO_I(zynq_ultra_ps_e_0_emio_i2c1_scl_o),
        .IOBUF_IO_IO(i2c1_scl[0]),
        .IOBUF_IO_O(util_ds_buf_0_IOBUF_IO_O),
        .IOBUF_IO_T(zynq_ultra_ps_e_0_emio_i2c1_scl_t));
  cpu_block_util_ds_buf_0_1 util_ds_buf_1
       (.IOBUF_IO_I(zynq_ultra_ps_e_0_emio_i2c1_sda_o),
        .IOBUF_IO_IO(i2c1_sda[0]),
        .IOBUF_IO_O(util_ds_buf_1_IOBUF_IO_O),
        .IOBUF_IO_T(zynq_ultra_ps_e_0_emio_i2c1_sda_t));
  cpu_block_util_vector_logic_0_0 util_vector_logic_0
       (.Op1(zynq_ultra_ps_e_0_pl_resetn0),
        .Res(util_vector_logic_0_Res));
  cpu_block_xlconstant_0_0 xlconstant_0
       (.dout(xlconstant_0_dout));
  cpu_block_xlconstant_1_0 xlconstant_1
       (.dout(xlconstant_1_dout));
  cpu_block_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0
       (.emio_i2c0_scl_i(1'b0),
        .emio_i2c0_sda_i(1'b0),
        .emio_i2c1_scl_i(util_ds_buf_0_IOBUF_IO_O),
        .emio_i2c1_scl_o(zynq_ultra_ps_e_0_emio_i2c1_scl_o),
        .emio_i2c1_scl_t(zynq_ultra_ps_e_0_emio_i2c1_scl_t),
        .emio_i2c1_sda_i(util_ds_buf_1_IOBUF_IO_O),
        .emio_i2c1_sda_o(zynq_ultra_ps_e_0_emio_i2c1_sda_o),
        .emio_i2c1_sda_t(zynq_ultra_ps_e_0_emio_i2c1_sda_t),
...
module cpu_block_axi_interconnect_0_0
  ...
  m00_couplers_imp_JJ0TPX m00_couplers
       (.M_ACLK(M00_ACLK_1),
  ...
  m01_couplers_imp_14DHFE5 m01_couplers
       (.M_ACLK(M01_ACLK_1),
  ...
  m02_couplers_imp_E3RVK4 m02_couplers
       (.M_ACLK(M02_ACLK_1),
  ...
  s00_couplers_imp_1POEQSP s00_couplers
...
module m00_couplers_imp_JJ0TPX
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arburst,
...
module m01_couplers_imp_14DHFE5
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arburst,
...
module m02_couplers_imp_E3RVK4
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arburst,
...
module s00_couplers_imp_1POEQSP
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arburst,
