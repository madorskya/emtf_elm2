...
-- Command     : write_vhdl -force -mode funcsim -rename_top cpu_block_util_ds_buf_0_0 -prefix
--               cpu_block_util_ds_buf_0_0_ cpu_block_util_ds_buf_0_0_sim_netlist.vhdl
...
entity cpu_block_util_ds_buf_0_0_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of cpu_block_util_ds_buf_0_0_util_ds_buf : entity is 1;
  attribute C_BUFG_GT_SYNC : integer;
  attribute C_BUFG_GT_SYNC of cpu_block_util_ds_buf_0_0_util_ds_buf : entity is 0;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of cpu_block_util_ds_buf_0_0_util_ds_buf : entity is "IOBUF";
  attribute C_SIM_DEVICE : string;
  attribute C_SIM_DEVICE of cpu_block_util_ds_buf_0_0_util_ds_buf : entity is "VERSAL_AI_CORE_ES1";
  attribute C_SIZE : integer;
  attribute C_SIZE of cpu_block_util_ds_buf_0_0_util_ds_buf : entity is 1;
end cpu_block_util_ds_buf_0_0_util_ds_buf;

architecture STRUCTURE of cpu_block_util_ds_buf_0_0_util_ds_buf is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity cpu_block_util_ds_buf_0_0 is
  port (
    IOBUF_IO_T : in STD_LOGIC_VECTOR ( 0 to 0 );
    IOBUF_IO_I : in STD_LOGIC_VECTOR ( 0 to 0 );
    IOBUF_IO_O : out STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute NotValidForBitStream of cpu_block_util_ds_buf_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of cpu_block_util_ds_buf_0_0 : entity is "cpu_block_util_ds_buf_0_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of cpu_block_util_ds_buf_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of cpu_block_util_ds_buf_0_0 : entity is "util_ds_buf,Vivado 2019.2";
end cpu_block_util_ds_buf_0_0;

architecture STRUCTURE of cpu_block_util_ds_buf_0_0 is
...
begin
U0: entity work.cpu_block_util_ds_buf_0_0_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
