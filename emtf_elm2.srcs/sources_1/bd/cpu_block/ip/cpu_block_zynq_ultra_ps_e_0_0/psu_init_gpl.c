...
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRL_APB_USB0_BUS_REF_CTRL_DIVISOR0                      0x3a
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E0060, 0x023F3F07U ,0x02013A00U)
    */
	PSU_Mask_Write(CRL_APB_USB0_BUS_REF_CTRL_OFFSET,
		0x023F3F07U, 0x02013A00U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080124, 0xFFFFFFFFU ,0x00391209U)
    */
	PSU_Mask_Write(DDR_PHY_DTPR5_OFFSET, 0xFFFFFFFFU, 0x00391209U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180204, 0x33FFFFFFU ,0x00000240U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI0_OFFSET,
		0x33FFFFFFU, 0x00000240U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180208, 0xFFFFFFC0U ,0x00B3F000U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI1_OFFSET,
		0xFFFFFFC0U, 0x00B3F000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_GPIO_DIRM_0_DIRECTION_0                                 0x60000

    * Direction mode (GPIO Bank0, MIO)
    * (OFFSET, MASK, VALUE)      (0XFF0A0204, 0x03FFFFFFU ,0x00060000U)
    */
	PSU_Mask_Write(GPIO_DIRM_0_OFFSET, 0x03FFFFFFU, 0x00060000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_GPIO_OEN_0_OP_ENABLE_0                                  0x60000

    * Output enable (GPIO Bank0, MIO)
    * (OFFSET, MASK, VALUE)      (0XFF0A0208, 0x03FFFFFFU ,0x00060000U)
    */
	PSU_Mask_Write(GPIO_OEN_0_OFFSET, 0x03FFFFFFU, 0x00060000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_GPIO_MASK_DATA_0_MSW_MASK_0_MSW                         0x0

    * Operation is the same as MASK_DATA_0_LSW[DATA_0_LSW]
    *  PSU_GPIO_MASK_DATA_0_MSW_DATA_0_MSW                         0x6

    * Maskable Output Data (GPIO Bank0, MIO, Upper 10bits)
    * (OFFSET, MASK, VALUE)      (0XFF0A0004, 0x03FF03FFU ,0x00000006U)
    */
	PSU_Mask_Write(GPIO_MASK_DATA_0_MSW_OFFSET,
		0x03FF03FFU, 0x00000006U);
/*##################################################################### */
