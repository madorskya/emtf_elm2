...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E0060 0x023F3F07 0x02013A00
    ...
    mask_write 0XFF5E0120 0x013F3F07 0x01033200
    ...
    mask_write 0XFF5E0124 0x013F3F07 0x01033200
...
set psu_ddr_init_data {
    ...
    mask_write 0XFD080124 0xFFFFFFFF 0x00391209
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180204 0x33FFFFFF 0x00000240
    ...
    mask_write 0XFF180208 0xFFFFFFC0 0x00B3F000
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFF0A0204 0x03FFFFFF 0x00060000
		# : DIR MODE BANK 1
		# : DIR MODE BANK 2
    ...
    mask_write 0XFF0A0208 0x03FFFFFF 0x00060000
    ...
    mask_write 0XFF0A0004 0x03FF03FF 0x00000006
