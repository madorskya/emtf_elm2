...
-- Date        : Thu Jun 18 10:37:18 2020
-- Host        : endcap-tf1.phys.ufl.edu running 64-bit CentOS Linux release 7.7.1908 (Core)
-- Command     : write_vhdl -force -mode funcsim -rename_top cpu_block_clk_wiz_0_0 -prefix
--               cpu_block_clk_wiz_0_0_ cpu_block_clk_wiz_0_0_sim_netlist.vhdl
...
entity cpu_block_clk_wiz_0_0_cpu_block_clk_wiz_0_0_clk_wiz is
  port (
...
end cpu_block_clk_wiz_0_0_cpu_block_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of cpu_block_clk_wiz_0_0_cpu_block_clk_wiz_0_0_clk_wiz is
  signal clk_in1_cpu_block_clk_wiz_0_0 : STD_LOGIC;
...
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_cpu_block_clk_wiz_0_0
    );
...
begin
inst: entity work.cpu_block_clk_wiz_0_0_cpu_block_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      locked => locked,
