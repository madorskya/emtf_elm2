...
################################################################
# This is a generated script based on design: cpu_block
#
...
proc create_root_design { parentCell } {
  ...
  set c2c_refclk [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 c2c_refclk ]
  ...
  # Create ports
  set ffly_rst [ create_bd_port -dir O -from 1 -to 0 ffly_rst ]
  set i2c1_scl [ create_bd_port -dir IO -from 0 -to 0 i2c1_scl ]
  set i2c1_sda [ create_bd_port -dir IO -from 0 -to 0 i2c1_sda ]
  set synth_rst [ create_bd_port -dir O -from 3 -to 0 synth_rst ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT1_JITTER {286.031} \
   CONFIG.CLKOUT1_PHASE_ERROR {427.460} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {50} \
   CONFIG.MMCM_CLKFBOUT_MULT_F {76.250} \
  ...
  connect_bd_intf_net -intf_net GT_DIFF_REFCLK1_0_1 [get_bd_intf_ports c2c_refclk] [get_bd_intf_pins aurora_64b66b_0/GT_DIFF_REFCLK1]
  connect_bd_intf_net -intf_net GT_SERIAL_RX_0_1 [get_bd_intf_ports c2c_rx] [get_bd_intf_pins aurora_64b66b_0/GT_SERIAL_RX]
  connect_bd_intf_net -intf_net aurora_64b66b_0_GT_SERIAL_TX [get_bd_intf_ports c2c_tx] [get_bd_intf_pins aurora_64b66b_0/GT_SERIAL_TX]
  ...
  connect_bd_net -net Net [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins axi_chip2chip_0/s_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  connect_bd_net -net Net1 [get_bd_ports i2c1_scl] [get_bd_pins util_ds_buf_0/IOBUF_IO_IO]
  connect_bd_net -net Net2 [get_bd_ports i2c1_sda] [get_bd_pins util_ds_buf_1/IOBUF_IO_IO]
  connect_bd_net -net aurora_64b66b_0_channel_up [get_bd_pins aurora_64b66b_0/channel_up] [get_bd_pins axi_chip2chip_0/axi_c2c_aurora_channel_up] [get_bd_pins gpio_split_0/i11]
  connect_bd_net -net aurora_64b66b_0_gt_powergood [get_bd_pins aurora_64b66b_0/gt_powergood] [get_bd_pins gpio_split_0/i3]
  connect_bd_net -net aurora_64b66b_0_gt_reset_out [get_bd_pins aurora_64b66b_0/gt_reset_out] [get_bd_pins gpio_split_0/i2]
  connect_bd_net -net aurora_64b66b_0_hard_err [get_bd_pins aurora_64b66b_0/hard_err] [get_bd_pins gpio_split_0/i13]
  connect_bd_net -net aurora_64b66b_0_lane_up [get_bd_pins aurora_64b66b_0/lane_up] [get_bd_pins gpio_split_0/i14]
  connect_bd_net -net aurora_64b66b_0_link_reset_out [get_bd_pins aurora_64b66b_0/link_reset_out] [get_bd_pins gpio_split_0/i0]
  connect_bd_net -net aurora_64b66b_0_m_axi_rx_tdata [get_bd_pins aurora_64b66b_0/m_axi_rx_tdata] [get_bd_pins axi_chip2chip_0/axi_c2c_aurora_rx_tdata]
  connect_bd_net -net aurora_64b66b_0_m_axi_rx_tvalid [get_bd_pins aurora_64b66b_0/m_axi_rx_tvalid] [get_bd_pins axi_chip2chip_0/axi_c2c_aurora_rx_tvalid]
  connect_bd_net -net aurora_64b66b_0_mmcm_not_locked_out [get_bd_pins aurora_64b66b_0/mmcm_not_locked_out] [get_bd_pins axi_chip2chip_0/aurora_mmcm_not_locked] [get_bd_pins gpio_split_0/i12]
  connect_bd_net -net aurora_64b66b_0_s_axi_tx_tready [get_bd_pins aurora_64b66b_0/s_axi_tx_tready] [get_bd_pins axi_chip2chip_0/axi_c2c_aurora_tx_tready]
  connect_bd_net -net aurora_64b66b_0_soft_err [get_bd_pins aurora_64b66b_0/soft_err] [get_bd_pins gpio_split_0/i15]
  connect_bd_net -net aurora_64b66b_0_sys_reset_out [get_bd_pins aurora_64b66b_0/sys_reset_out] [get_bd_pins gpio_split_0/i1]
  ...
  connect_bd_net -net axi_bram_ctrl_1_bram_addr_a [get_bd_pins axi_bram_ctrl_1/bram_addr_a] [get_bd_pins gpio_split_0/addr]
  connect_bd_net -net axi_bram_ctrl_1_bram_clk_a [get_bd_pins axi_bram_ctrl_1/bram_clk_a] [get_bd_pins gpio_split_0/clk_a]
  connect_bd_net -net axi_bram_ctrl_1_bram_en_a [get_bd_pins axi_bram_ctrl_1/bram_en_a] [get_bd_pins gpio_split_0/en]
  connect_bd_net -net axi_bram_ctrl_1_bram_rst_a [get_bd_pins axi_bram_ctrl_1/bram_rst_a] [get_bd_pins gpio_split_0/rst]
  connect_bd_net -net axi_bram_ctrl_1_bram_we_a [get_bd_pins axi_bram_ctrl_1/bram_we_a] [get_bd_pins gpio_split_0/we]
  connect_bd_net -net axi_bram_ctrl_1_bram_wrdata_a [get_bd_pins axi_bram_ctrl_1/bram_wrdata_a] [get_bd_pins gpio_split_0/wr_data]
  connect_bd_net -net axi_chip2chip_0_aurora_pma_init_out [get_bd_pins aurora_64b66b_0/pma_init] [get_bd_pins axi_chip2chip_0/aurora_pma_init_out] [get_bd_pins gpio_split_0/i4]
  connect_bd_net -net axi_chip2chip_0_aurora_reset_pb [get_bd_pins aurora_64b66b_0/reset_pb] [get_bd_pins axi_chip2chip_0/aurora_reset_pb] [get_bd_pins gpio_split_0/i5]
  connect_bd_net -net axi_chip2chip_0_axi_c2c_aurora_tx_tdata [get_bd_pins aurora_64b66b_0/s_axi_tx_tdata] [get_bd_pins axi_chip2chip_0/axi_c2c_aurora_tx_tdata]
  connect_bd_net -net axi_chip2chip_0_axi_c2c_aurora_tx_tvalid [get_bd_pins aurora_64b66b_0/s_axi_tx_tvalid] [get_bd_pins axi_chip2chip_0/axi_c2c_aurora_tx_tvalid]
  connect_bd_net -net axi_chip2chip_0_axi_c2c_config_error_out [get_bd_pins axi_chip2chip_0/axi_c2c_config_error_out] [get_bd_pins gpio_split_0/i6]
  connect_bd_net -net axi_chip2chip_0_axi_c2c_link_error_out [get_bd_pins axi_chip2chip_0/axi_c2c_link_error_out] [get_bd_pins gpio_split_0/i9]
  connect_bd_net -net axi_chip2chip_0_axi_c2c_link_status_out [get_bd_pins axi_chip2chip_0/axi_c2c_link_status_out] [get_bd_pins gpio_split_0/i7]
  connect_bd_net -net axi_chip2chip_0_axi_c2c_multi_bit_error_out [get_bd_pins axi_chip2chip_0/axi_c2c_multi_bit_error_out] [get_bd_pins gpio_split_0/i8]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins aurora_64b66b_0/init_clk] [get_bd_pins axi_chip2chip_0/aurora_init_clk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins dsync_0/clk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins proc_sys_reset_0/ext_reset_in]
  connect_bd_net -net dsync_0_outp [get_bd_pins axi_chip2chip_0/aurora_pma_init_in] [get_bd_pins dsync_0/outp]
  connect_bd_net -net gpio_split_0_o0 [get_bd_pins dsync_0/inp] [get_bd_pins gpio_split_0/i10] [get_bd_pins gpio_split_0/o0]
  connect_bd_net -net gpio_split_0_rd_data [get_bd_pins axi_bram_ctrl_1/bram_rddata_a] [get_bd_pins gpio_split_0/rd_data]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins axi_chip2chip_0/s_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net util_ds_buf_0_IOBUF_IO_O [get_bd_pins util_ds_buf_0/IOBUF_IO_O] [get_bd_pins zynq_ultra_ps_e_0/emio_i2c1_scl_i]
  connect_bd_net -net util_ds_buf_1_IOBUF_IO_O [get_bd_pins util_ds_buf_1/IOBUF_IO_O] [get_bd_pins zynq_ultra_ps_e_0/emio_i2c1_sda_i]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins clk_wiz_0/reset] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net xlconstant_0_dout [get_bd_ports synth_rst] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_ports ffly_rst] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_emio_i2c1_scl_o [get_bd_pins util_ds_buf_0/IOBUF_IO_I] [get_bd_pins zynq_ultra_ps_e_0/emio_i2c1_scl_o]
  connect_bd_net -net zynq_ultra_ps_e_0_emio_i2c1_scl_t [get_bd_pins util_ds_buf_0/IOBUF_IO_T] [get_bd_pins zynq_ultra_ps_e_0/emio_i2c1_scl_t]
  connect_bd_net -net zynq_ultra_ps_e_0_emio_i2c1_sda_o [get_bd_pins util_ds_buf_1/IOBUF_IO_I] [get_bd_pins zynq_ultra_ps_e_0/emio_i2c1_sda_o]
  connect_bd_net -net zynq_ultra_ps_e_0_emio_i2c1_sda_t [get_bd_pins util_ds_buf_1/IOBUF_IO_T] [get_bd_pins zynq_ultra_ps_e_0/emio_i2c1_sda_t]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins util_vector_logic_0/Op1] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]

  # Create address segments
  assign_bd_address -offset 0x80101000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0x80100000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] -force
  assign_bd_address -offset 0x80000000 -range 0x00100000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_chip2chip_0/s_axi/Mem0] -force
